...
export async function setup(project: TestProject) {
	...
	// prettier-ignore
	let container = await $`docker run --rm --detach --hostname localhost --platform linux/amd64 --publish 2135 --publish 2136 --publish 8765 --publish 9092 ydbplatform/local-ydb:25.2`.text()
