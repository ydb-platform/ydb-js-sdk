		...
		for (let file of schema.files) {
			...
			for (let service of file.services) {
				...
				for (let method of service.methods) {
					...
					f.print("    requestSerialize: (message: ", bufProtoMessageInitShape, "<typeof ", requestSchema, ">) => ",
						bufProtoToBinary, "(", requestSchema, ", ", bufProtoCreate, "(", requestSchema, ", message)),")
					...
					f.print("    responseSerialize: (message: ", bufProtoMessageInitShape, "<typeof ", responseSchema, ">) => ",
						bufProtoToBinary, "(", responseSchema, ", ", bufProtoCreate, "(", responseSchema, ", message)),")
