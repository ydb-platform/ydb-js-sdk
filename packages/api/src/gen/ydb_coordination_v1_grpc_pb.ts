...
export const CoordinationServiceDefinition = {
	...
	session: {
		...
		requestStream: true,
		requestSerialize: (
			message: MessageInitShape<typeof SessionRequestSchema>
		) =>
			toBinary(
				SessionRequestSchema,
				create(SessionRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(SessionRequestSchema, bytes),
		responseStream: true,
		responseSerialize: (
			message: MessageInitShape<typeof SessionResponseSchema>
		) =>
			toBinary(
				SessionResponseSchema,
				create(SessionResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(SessionResponseSchema, bytes),
		options: {},
	},
	/**
	...
	createNode: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof CreateNodeRequestSchema>
		) =>
			toBinary(
				CreateNodeRequestSchema,
				create(CreateNodeRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(CreateNodeRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof CreateNodeResponseSchema>
		) =>
			toBinary(
				CreateNodeResponseSchema,
				create(CreateNodeResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(CreateNodeResponseSchema, bytes),
		options: {},
	},
	/**
	...
	alterNode: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof AlterNodeRequestSchema>
		) =>
			toBinary(
				AlterNodeRequestSchema,
				create(AlterNodeRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(AlterNodeRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof AlterNodeResponseSchema>
		) =>
			toBinary(
				AlterNodeResponseSchema,
				create(AlterNodeResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(AlterNodeResponseSchema, bytes),
		options: {},
	},
	/**
	...
	dropNode: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof DropNodeRequestSchema>
		) =>
			toBinary(
				DropNodeRequestSchema,
				create(DropNodeRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(DropNodeRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof DropNodeResponseSchema>
		) =>
			toBinary(
				DropNodeResponseSchema,
				create(DropNodeResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(DropNodeResponseSchema, bytes),
		options: {},
	},
	/**
	...
	describeNode: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof DescribeNodeRequestSchema>
		) =>
			toBinary(
				DescribeNodeRequestSchema,
				create(DescribeNodeRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(DescribeNodeRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof DescribeNodeResponseSchema>
		) =>
			toBinary(
				DescribeNodeResponseSchema,
				create(DescribeNodeResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(DescribeNodeResponseSchema, bytes),
		options: {},
	},
...
//@ts-expect-error
CoordinationServiceDefinition['fullName'] =
