...
/**
 * Describes the message Ydb.Query.SessionShutdownHint.
 * Use `create(SessionShutdownHintSchema)` to create a new message.
 */
export const SessionShutdownHintSchema: GenMessage<SessionShutdownHint> = /*@__PURE__*/
...
/**
 * Describes the message Ydb.Query.NodeShutdownHint.
 * Use `create(NodeShutdownHintSchema)` to create a new message.
 */
export const NodeShutdownHintSchema: GenMessage<NodeShutdownHint> = /*@__PURE__*/
...
export type SessionState = Message<"Ydb.Query.SessionState"> & {
   ...
   *
   * @generated from oneof Ydb.Query.SessionState.session_hint
   */
  sessionHint: {
    /**
     * @generated from field: Ydb.Query.SessionShutdownHint session_shutdown = 3;
     */
    value: SessionShutdownHint;
    case: "sessionShutdown";
  } | {
    /**
     * @generated from field: Ydb.Query.NodeShutdownHint node_shutdown = 4;
     */
    value: NodeShutdownHint;
    case: "nodeShutdown";
...
export type ExecuteQueryRequest = Message<"Ydb.Query.ExecuteQueryRequest"> & {
   ...
   */
  arrowFormatSettings?: ArrowFormatSettings | undefined;
};
...
export type ExecuteQueryResponsePart = Message<"Ydb.Query.ExecuteQueryResponsePart"> & {
   ...
   */
  execStats?: QueryStats | undefined;
...
export type ExecuteScriptRequest = Message<"Ydb.Query.ExecuteScriptRequest"> & {
   ...
   */
  scriptContent?: QueryContent | undefined;
