 ...
 */
export const file_protos_ydb_discovery: GenFile =
	/*@__PURE__*/
	fileDesc(
		'',
...
export type ListEndpointsRequest =
	Message<'Ydb.Discovery.ListEndpointsRequest'> & {
		/**
 ...
 */
export const ListEndpointsRequestSchema: GenMessage<ListEndpointsRequest> =
	/*@__PURE__*/
...
export type ListEndpointsResult =
	Message<'Ydb.Discovery.ListEndpointsResult'> & {
		/**
 ...
 */
export const ListEndpointsResultSchema: GenMessage<ListEndpointsResult> =
	/*@__PURE__*/
...
export type ListEndpointsResponse =
	Message<'Ydb.Discovery.ListEndpointsResponse'> & {
		/**
 ...
 */
export const ListEndpointsResponseSchema: GenMessage<ListEndpointsResponse> =
	/*@__PURE__*/
