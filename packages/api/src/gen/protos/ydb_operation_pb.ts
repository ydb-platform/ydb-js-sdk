 ...
 */
export const file_protos_ydb_operation: GenFile =
	/*@__PURE__*/
	fileDesc(
		'',
		[
 ...
 */
export const OperationParamsSchema: GenMessage<OperationParams> =
	/*@__PURE__*/
 ...
 */
export const OperationParams_OperationModeSchema: GenEnum<OperationParams_OperationMode> =
	/*@__PURE__*/
...
export type GetOperationRequest =
	Message<'Ydb.Operations.GetOperationRequest'> & {
		/**
...
export type GetOperationResponse =
	Message<'Ydb.Operations.GetOperationResponse'> & {
		/**
 ...
 */
export const GetOperationResponseSchema: GenMessage<GetOperationResponse> =
	/*@__PURE__*/
...
export type CancelOperationRequest =
	Message<'Ydb.Operations.CancelOperationRequest'> & {
		/**
		 * @generated from field: string id = 1;
		 */
		id: string
...
export type CancelOperationResponse =
	Message<'Ydb.Operations.CancelOperationResponse'> & {
		/**
 ...
 */
export type ForgetOperationRequest =
 ...
 */
export const ForgetOperationRequestSchema: GenMessage<ForgetOperationRequest> =
	/*@__PURE__*/
 ...
 */
export type ForgetOperationResponse =
	Message<'Ydb.Operations.ForgetOperationResponse'> & {
		/**
		 * @generated from field: Ydb.StatusIds.StatusCode status = 1;
		 */
		status: StatusIds_StatusCode
 ...
 */
export const ForgetOperationResponseSchema: GenMessage<ForgetOperationResponse> =
	/*@__PURE__*/
...
export type ListOperationsResponse =
	Message<'Ydb.Operations.ListOperationsResponse'> & {
		/**
		 * @generated from field: Ydb.StatusIds.StatusCode status = 1;
		 */
		status: StatusIds_StatusCode
