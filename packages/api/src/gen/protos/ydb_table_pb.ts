...
export type Changefeed = Message<"Ydb.Table.Changefeed"> & {
   ...
   */
  resolvedTimestampsInterval?: Duration | undefined;
   ...
   */
  topicPartitioningSettings?: PartitioningSettings$1 | undefined;
...
export type ChangefeedDescription = Message<"Ydb.Table.ChangefeedDescription"> & {
   ...
   */
  initialScanProgress?: ChangefeedDescription_InitialScanProgress | undefined;
 ...
 */
export type ChangefeedDescription_InitialScanProgress = Message<"Ydb.Table.ChangefeedDescription.InitialScanProgress"> & {
  /**
 ...
 */
export const ChangefeedDescription_InitialScanProgressSchema: GenMessage<ChangefeedDescription_InitialScanProgress> = /*@__PURE__*/
...
export type TableStats = Message<"Ydb.Table.TableStats"> & {
   ...
   */
  modificationTime?: Timestamp | undefined;
};
...
export type SequenceDescription = Message<"Ydb.Table.SequenceDescription"> & {
   ...
   */
  setVal?: SequenceDescription_SetVal | undefined;
};
...
export type SequenceDescription_SetVal = Message<"Ydb.Table.SequenceDescription.SetVal"> & {
   ...
   */
  nextValue?: bigint | undefined;

  /**
   * @generated from field: optional bool next_used = 2;
   */
  nextUsed?: boolean | undefined;
};
...
export type StorageSettings = Message<"Ydb.Table.StorageSettings"> & {
   ...
   */
  tabletCommitLog0?: StoragePool | undefined;
   ...
   */
  tabletCommitLog1?: StoragePool | undefined;
...
export type CreateTableRequest = Message<"Ydb.Table.CreateTableRequest"> & {
   ...
   */
  ttlSettings?: TtlSettings | undefined;
   ...
   */
  partitioningSettings?: PartitioningSettings | undefined;
...
export type AlterTableRequest = Message<"Ydb.Table.AlterTableRequest"> & {
   ...
   */
  alterStorageSettings?: StorageSettings | undefined;
   ...
   */
  alterPartitioningSettings?: PartitioningSettings | undefined;
   ...
   */
  setReadReplicasSettings?: ReadReplicasSettings | undefined;
 ...
 */
export type SnapshotRWModeSettings = Message<"Ydb.Table.SnapshotRWModeSettings"> & {
};
 ...
 */
export const SnapshotRWModeSettingsSchema: GenMessage<SnapshotRWModeSettings> = /*@__PURE__*/
...
export type ReadTableResponse = Message<"Ydb.Table.ReadTableResponse"> & {
   ...
   */
  snapshot?: VirtualTimestamp | undefined;
 ...
 */
export type DescribeExternalDataSourceRequest = Message<"Ydb.Table.DescribeExternalDataSourceRequest"> & {
  /**
   * @generated from field: Ydb.Operations.OperationParams operation_params = 1;
   */
  operationParams?: OperationParams | undefined;
 ...
 */
export const DescribeExternalDataSourceRequestSchema: GenMessage<DescribeExternalDataSourceRequest> = /*@__PURE__*/
  messageDesc(file_protos_ydb_table, 114);

/**
 * @generated from message Ydb.Table.DescribeExternalDataSourceResponse
 */
export type DescribeExternalDataSourceResponse = Message<"Ydb.Table.DescribeExternalDataSourceResponse"> & {
  /**
 ...
 */
export const DescribeExternalDataSourceResponseSchema: GenMessage<DescribeExternalDataSourceResponse> = /*@__PURE__*/
  messageDesc(file_protos_ydb_table, 115);

/**
 * @generated from message Ydb.Table.DescribeExternalDataSourceResult
 */
export type DescribeExternalDataSourceResult = Message<"Ydb.Table.DescribeExternalDataSourceResult"> & {
  /**
 ...
 */
export const DescribeExternalDataSourceResultSchema: GenMessage<DescribeExternalDataSourceResult> = /*@__PURE__*/
 ...
 */
export type DescribeExternalTableRequest = Message<"Ydb.Table.DescribeExternalTableRequest"> & {
  /**
   * @generated from field: Ydb.Operations.OperationParams operation_params = 1;
   */
  operationParams?: OperationParams | undefined;
 ...
 */
export const DescribeExternalTableRequestSchema: GenMessage<DescribeExternalTableRequest> = /*@__PURE__*/
  messageDesc(file_protos_ydb_table, 117);

/**
 * @generated from message Ydb.Table.DescribeExternalTableResponse
 */
export type DescribeExternalTableResponse = Message<"Ydb.Table.DescribeExternalTableResponse"> & {
  /**
 ...
 */
export const DescribeExternalTableResponseSchema: GenMessage<DescribeExternalTableResponse> = /*@__PURE__*/
  messageDesc(file_protos_ydb_table, 118);

/**
 * @generated from message Ydb.Table.DescribeExternalTableResult
 */
export type DescribeExternalTableResult = Message<"Ydb.Table.DescribeExternalTableResult"> & {
  /**
   * Description of a generic scheme object.
   *
   * @generated from field: Ydb.Scheme.Entry self = 1;
 ...
 */
export const DescribeExternalTableResultSchema: GenMessage<DescribeExternalTableResult> = /*@__PURE__*/
 ...
 */
export type DescribeSystemViewRequest = Message<"Ydb.Table.DescribeSystemViewRequest"> & {
  /**
   * @generated from field: Ydb.Operations.OperationParams operation_params = 1;
   */
  operationParams?: OperationParams | undefined;
 ...
 */
export const DescribeSystemViewRequestSchema: GenMessage<DescribeSystemViewRequest> = /*@__PURE__*/
  messageDesc(file_protos_ydb_table, 120);

/**
 * @generated from message Ydb.Table.DescribeSystemViewResponse
 */
export type DescribeSystemViewResponse = Message<"Ydb.Table.DescribeSystemViewResponse"> & {
  /**
 ...
 */
export const DescribeSystemViewResponseSchema: GenMessage<DescribeSystemViewResponse> = /*@__PURE__*/
  messageDesc(file_protos_ydb_table, 121);

/**
 * @generated from message Ydb.Table.DescribeSystemViewResult
 */
export type DescribeSystemViewResult = Message<"Ydb.Table.DescribeSystemViewResult"> & {
  /**
   * Description of scheme object
   *
   * @generated from field: Ydb.Scheme.Entry self = 1;
 ...
 */
export const DescribeSystemViewResultSchema: GenMessage<DescribeSystemViewResult> = /*@__PURE__*/
