...
export const TableServiceDefinition = {
  ...
  describeExternalDataSource: {
    ...
    requestStream: false,
    requestSerialize: (message: MessageInitShape<typeof DescribeExternalDataSourceRequestSchema>) => toBinary(DescribeExternalDataSourceRequestSchema, create(DescribeExternalDataSourceRequestSchema, message)),
    requestDeserialize: (bytes: Uint8Array) => fromBinary(DescribeExternalDataSourceRequestSchema,bytes),
      responseStream: false, 
    responseSerialize: (message: MessageInitShape<typeof DescribeExternalDataSourceResponseSchema>) => toBinary(DescribeExternalDataSourceResponseSchema, create(DescribeExternalDataSourceResponseSchema, message)),
    responseDeserialize: (bytes: Uint8Array) => fromBinary(DescribeExternalDataSourceResponseSchema,bytes),
    options: {},
  },
  /**
  ...
  describeExternalTable: {
    ...
    requestStream: false,
    requestSerialize: (message: MessageInitShape<typeof DescribeExternalTableRequestSchema>) => toBinary(DescribeExternalTableRequestSchema, create(DescribeExternalTableRequestSchema, message)),
    requestDeserialize: (bytes: Uint8Array) => fromBinary(DescribeExternalTableRequestSchema,bytes),
      responseStream: false, 
    responseSerialize: (message: MessageInitShape<typeof DescribeExternalTableResponseSchema>) => toBinary(DescribeExternalTableResponseSchema, create(DescribeExternalTableResponseSchema, message)),
    responseDeserialize: (bytes: Uint8Array) => fromBinary(DescribeExternalTableResponseSchema,bytes),
    options: {},
  },
  /**
  ...
  describeSystemView: {
    ...
    requestStream: false,
    requestSerialize: (message: MessageInitShape<typeof DescribeSystemViewRequestSchema>) => toBinary(DescribeSystemViewRequestSchema, create(DescribeSystemViewRequestSchema, message)),
    requestDeserialize: (bytes: Uint8Array) => fromBinary(DescribeSystemViewRequestSchema,bytes),
      responseStream: false, 
    responseSerialize: (message: MessageInitShape<typeof DescribeSystemViewResponseSchema>) => toBinary(DescribeSystemViewResponseSchema, create(DescribeSystemViewResponseSchema, message)),
    responseDeserialize: (bytes: Uint8Array) => fromBinary(DescribeSystemViewResponseSchema,bytes),
    options: {},
  },
