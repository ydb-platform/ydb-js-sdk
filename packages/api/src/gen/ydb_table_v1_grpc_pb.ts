...
import {
	...
	CopyTableRequestSchema,
	CopyTableResponseSchema,
	CopyTablesRequestSchema,
	CopyTablesResponseSchema,
	...
	DropTableRequestSchema,
	DropTableResponseSchema,
	ExecuteDataQueryRequestSchema,
	ExecuteDataQueryResponseSchema,
	ExecuteScanQueryPartialResponseSchema,
	ExecuteScanQueryRequestSchema,
	ExecuteSchemeQueryRequestSchema,
	ExecuteSchemeQueryResponseSchema,
	ExplainDataQueryRequestSchema,
	ExplainDataQueryResponseSchema,
	KeepAliveRequestSchema,
	KeepAliveResponseSchema,
	PrepareDataQueryRequestSchema,
	PrepareDataQueryResponseSchema,
	ReadRowsRequestSchema,
	ReadRowsResponseSchema,
	ReadTableRequestSchema,
	ReadTableResponseSchema,
	RenameTablesRequestSchema,
	RenameTablesResponseSchema,
	RollbackTransactionRequestSchema,
	RollbackTransactionResponseSchema,
} from './protos/ydb_table_pb.js'
...
export const TableServiceDefinition = {
	...
	keepAlive: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof KeepAliveRequestSchema>
		) =>
			toBinary(
				KeepAliveRequestSchema,
				create(KeepAliveRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(KeepAliveRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof KeepAliveResponseSchema>
		) =>
			toBinary(
				KeepAliveResponseSchema,
				create(KeepAliveResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(KeepAliveResponseSchema, bytes),
		options: {},
	},
	/**
	 * Creates new table.
	...
	createTable: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof CreateTableRequestSchema>
		) =>
			toBinary(
				CreateTableRequestSchema,
				create(CreateTableRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(CreateTableRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof CreateTableResponseSchema>
		) =>
			toBinary(
				CreateTableResponseSchema,
				create(CreateTableResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(CreateTableResponseSchema, bytes),
		options: {},
	},
	/**
	 * Drop table.
	...
	dropTable: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof DropTableRequestSchema>
		) =>
			toBinary(
				DropTableRequestSchema,
				create(DropTableRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(DropTableRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof DropTableResponseSchema>
		) =>
			toBinary(
				DropTableResponseSchema,
				create(DropTableResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(DropTableResponseSchema, bytes),
		options: {},
	},
	/**
	...
	alterTable: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof AlterTableRequestSchema>
		) =>
			toBinary(
				AlterTableRequestSchema,
				create(AlterTableRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(AlterTableRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof AlterTableResponseSchema>
		) =>
			toBinary(
				AlterTableResponseSchema,
				create(AlterTableResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(AlterTableResponseSchema, bytes),
		options: {},
	},
	/**
	...
	copyTable: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof CopyTableRequestSchema>
		) =>
			toBinary(
				CopyTableRequestSchema,
				create(CopyTableRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(CopyTableRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof CopyTableResponseSchema>
		) =>
			toBinary(
				CopyTableResponseSchema,
				create(CopyTableResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(CopyTableResponseSchema, bytes),
		options: {},
	},
	/**
	...
	copyTables: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof CopyTablesRequestSchema>
		) =>
			toBinary(
				CopyTablesRequestSchema,
				create(CopyTablesRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(CopyTablesRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof CopyTablesResponseSchema>
		) =>
			toBinary(
				CopyTablesResponseSchema,
				create(CopyTablesResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(CopyTablesResponseSchema, bytes),
		options: {},
	},
	/**
	...
	renameTables: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof RenameTablesRequestSchema>
		) =>
			toBinary(
				RenameTablesRequestSchema,
				create(RenameTablesRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(RenameTablesRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof RenameTablesResponseSchema>
		) =>
			toBinary(
				RenameTablesResponseSchema,
				create(RenameTablesResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(RenameTablesResponseSchema, bytes),
		options: {},
	},
	/**
	...
	describeTable: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof DescribeTableRequestSchema>
		) =>
			toBinary(
				DescribeTableRequestSchema,
				create(DescribeTableRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(DescribeTableRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof DescribeTableResponseSchema>
		) =>
			toBinary(
				DescribeTableResponseSchema,
				create(DescribeTableResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(DescribeTableResponseSchema, bytes),
		options: {},
	},
	/**
	 * Explains data query.
	...
	explainDataQuery: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof ExplainDataQueryRequestSchema>
		) =>
			toBinary(
				ExplainDataQueryRequestSchema,
				create(ExplainDataQueryRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(ExplainDataQueryRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof ExplainDataQueryResponseSchema>
		) =>
			toBinary(
				ExplainDataQueryResponseSchema,
				create(ExplainDataQueryResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(ExplainDataQueryResponseSchema, bytes),
		options: {},
	},
	/**
	...
	prepareDataQuery: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof PrepareDataQueryRequestSchema>
		) =>
			toBinary(
				PrepareDataQueryRequestSchema,
				create(PrepareDataQueryRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(PrepareDataQueryRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof PrepareDataQueryResponseSchema>
		) =>
			toBinary(
				PrepareDataQueryResponseSchema,
				create(PrepareDataQueryResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(PrepareDataQueryResponseSchema, bytes),
		options: {},
	},
	/**
	 * Executes data query.
	...
	executeDataQuery: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof ExecuteDataQueryRequestSchema>
		) =>
			toBinary(
				ExecuteDataQueryRequestSchema,
				create(ExecuteDataQueryRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(ExecuteDataQueryRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof ExecuteDataQueryResponseSchema>
		) =>
			toBinary(
				ExecuteDataQueryResponseSchema,
				create(ExecuteDataQueryResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(ExecuteDataQueryResponseSchema, bytes),
		options: {},
	},
	/**
	...
	executeSchemeQuery: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof ExecuteSchemeQueryRequestSchema>
		) =>
			toBinary(
				ExecuteSchemeQueryRequestSchema,
				create(ExecuteSchemeQueryRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(ExecuteSchemeQueryRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof ExecuteSchemeQueryResponseSchema>
		) =>
			toBinary(
				ExecuteSchemeQueryResponseSchema,
				create(ExecuteSchemeQueryResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(ExecuteSchemeQueryResponseSchema, bytes),
		options: {},
	},
	/**
	...
	describeTableOptions: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof DescribeTableOptionsRequestSchema>
		) =>
			toBinary(
				DescribeTableOptionsRequestSchema,
				create(DescribeTableOptionsRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(DescribeTableOptionsRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof DescribeTableOptionsResponseSchema>
		) =>
			toBinary(
				DescribeTableOptionsResponseSchema,
				create(DescribeTableOptionsResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(DescribeTableOptionsResponseSchema, bytes),
		options: {},
	},
	/**
	...
	streamReadTable: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof ReadTableRequestSchema>
		) =>
			toBinary(
				ReadTableRequestSchema,
				create(ReadTableRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(ReadTableRequestSchema, bytes),
		responseStream: true,
		responseSerialize: (
			message: MessageInitShape<typeof ReadTableResponseSchema>
		) =>
			toBinary(
				ReadTableResponseSchema,
				create(ReadTableResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(ReadTableResponseSchema, bytes),
		options: {},
	},
	/**
	...
	readRows: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof ReadRowsRequestSchema>
		) =>
			toBinary(
				ReadRowsRequestSchema,
				create(ReadRowsRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(ReadRowsRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof ReadRowsResponseSchema>
		) =>
			toBinary(
				ReadRowsResponseSchema,
				create(ReadRowsResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(ReadRowsResponseSchema, bytes),
		options: {},
	},
	/**
	...
	bulkUpsert: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof BulkUpsertRequestSchema>
		) =>
			toBinary(
				BulkUpsertRequestSchema,
				create(BulkUpsertRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(BulkUpsertRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof BulkUpsertResponseSchema>
		) =>
			toBinary(
				BulkUpsertResponseSchema,
				create(BulkUpsertResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(BulkUpsertResponseSchema, bytes),
		options: {},
	},
	/**
	...
	streamExecuteScanQuery: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof ExecuteScanQueryRequestSchema>
		) =>
			toBinary(
				ExecuteScanQueryRequestSchema,
				create(ExecuteScanQueryRequestSchema, message)
			),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(ExecuteScanQueryRequestSchema, bytes),
		responseStream: true,
		responseSerialize: (
			message: MessageInitShape<
				typeof ExecuteScanQueryPartialResponseSchema
			>
		) =>
			toBinary(
				ExecuteScanQueryPartialResponseSchema,
				create(ExecuteScanQueryPartialResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
