...
} from './protos/ydb_discovery_pb.js'
...
export const DiscoveryServiceDefinition = {
	...
	listEndpoints: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof ListEndpointsRequestSchema>
		) =>
			toBinary(
				ListEndpointsRequestSchema,
		...
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(ListEndpointsRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof ListEndpointsResponseSchema>
		) =>
			toBinary(
				ListEndpointsResponseSchema,
				create(ListEndpointsResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(ListEndpointsResponseSchema, bytes),
		options: {},
	},
	/**
	...
	whoAmI: {
		...
		requestStream: false,
		requestSerialize: (
			message: MessageInitShape<typeof WhoAmIRequestSchema>
		) =>
			toBinary(WhoAmIRequestSchema, create(WhoAmIRequestSchema, message)),
		requestDeserialize: (bytes: Uint8Array) =>
			fromBinary(WhoAmIRequestSchema, bytes),
		responseStream: false,
		responseSerialize: (
			message: MessageInitShape<typeof WhoAmIResponseSchema>
		) =>
			toBinary(
				WhoAmIResponseSchema,
				create(WhoAmIResponseSchema, message)
			),
		responseDeserialize: (bytes: Uint8Array) =>
			fromBinary(WhoAmIResponseSchema, bytes),
		options: {},
	},
