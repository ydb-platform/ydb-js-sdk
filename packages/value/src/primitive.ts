...
export class TzDatetime extends PrimitiveValue implements Value<PrimitiveType> {
	constructor(value: TZDate) {
		...
		super({ value: { case: 'textValue', value: `${date}T${time},${value.timeZone}` } }, Ydb.Type_PrimitiveTypeId.TZ_DATETIME);
	}
}
...
export class TzTimestamp extends PrimitiveValue implements Value<PrimitiveType> {
	constructor(value: TZDate) {
		...
		super({ value: { case: 'textValue', value: `${date}T${time}.${micro},${value.timeZone}` } }, Ydb.Type_PrimitiveTypeId.TZ_TIMESTAMP);
	}
}
