...
- **Пул сессий**: сессии автоматически переиспользуются между запросами и транзакциями (размер пула по умолчанию: 50). Настройка: `query(driver, { poolOptions: { maxSize: 100 } })`.
